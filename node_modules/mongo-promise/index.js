...
function formatId(query) {
  ...
  console.log('formatted Id', clone, query)
  return clone
}
...
var db = {
  ...
  collection: {
    ...
    findByAdapterId: function(collName, id) {
      console.log(collName)
      return db.getCollection(collName).then(function(c) {
        return new rsvp.Promise(function(res, rej) {
          c.findOne({refs: { $elemMatch : {id : id} } }, function(e, doc) {
            e ? rej(e) : res(doc)
          })
        })
      })
    ...
    findAndModify: function(collName, query, sort, updated, options) {
      return db.getCollection(collName).then(function(c) {
        return new rsvp.Promise(function(res, rej) {
          console.log('findingandmodifying', query, sort, updated, options)
          c.findAndModify(query, sort, updated, options, function(e, doc) {
            e ? rej(e) : res(doc)
          })
        })
      })
